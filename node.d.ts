...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"image" | "line" | "text" | "current" | "back" | "hover" | "card" | "special" | "control" | "shade" | "focus" | "field" | "spirit" | "hue" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
    ...
    export class $giper_baza_flex_prop extends $giper_baza_flex_prop_base {
        ...
        type(next?: string): string;
        base(next?: $giper_baza_vary_type): string | number | bigint | boolean | Element | $giper_baza_link | Uint8Array<ArrayBuffer> | $mol_tree2 | $mol_time_duration | $mol_time_moment | $mol_time_interval | Uint16Array<ArrayBuffer> | Uint32Array<ArrayBuffer> | BigUint64Array<ArrayBuffer> | Int8Array<ArrayBuffer> | Int16Array<ArrayBuffer> | Int32Array<ArrayBuffer> | BigInt64Array<ArrayBuffer> | Float64Array<ArrayBuffer> | Float32Array<ArrayBuffer> | readonly $giper_baza_vary_type[] | Readonly<{
...
declare namespace $ {
	...
	type $mol_number__hint_bog_leaderboard_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_number__value_bog_leaderboard_2 = $mol_type_enforce<
		ReturnType< $bog_leaderboard['my_score'] >
		,
	...
	>
	export class $bog_leaderboard extends $mol_page {
	...
	type $mol_view__sub_bog_leaderboard_row_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_leaderboard_row_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_leaderboard_row_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_leaderboard_row extends $mol_view {
		place( ): string
		Place( ): $mol_view
		name( ): string
		Name( ): $mol_view
...
declare namespace $.$$ {
    const $bog_leaderboard_entry_base: Omit<typeof $giper_baza_dict, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_dict, {
