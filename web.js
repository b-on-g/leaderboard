...
;
	($.$bog_leaderboard) = class $bog_leaderboard extends ($.$mol_page) {
		Theme(){
		...
		body(){
			return [(this.Score_input()), (this.Board())];
		}
	};
	($mol_mem(($.$bog_leaderboard.prototype), "Theme"));
	...
	($mol_mem(($.$bog_leaderboard_row.prototype), "Place"));
	($mol_mem(($.$bog_leaderboard_row.prototype), "Name"));
	($mol_mem(($.$bog_leaderboard_row.prototype), "Score"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_leaderboard.prototype, "my_lord_str", null);
        __decorate([
            $mol_mem
        ], $bog_leaderboard.prototype, "my_entry", null);
        __decorate([
            $mol_mem
