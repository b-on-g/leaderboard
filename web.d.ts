...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"image" | "line" | "text" | "field" | "current" | "hover" | "back" | "card" | "special" | "control" | "shade" | "focus" | "spirit" | "hue" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $.$$ {
    class $giper_baza_flex_field extends $.$giper_baza_flex_field {
        dict_pawn(): $giper_baza_dict;
        Sub(): $.$mol_number | $.$mol_select | $.$mol_expander | $.$mol_drop | $.$mol_textarea | $.$mol_date | $mol_check_box | $mol_bar;
